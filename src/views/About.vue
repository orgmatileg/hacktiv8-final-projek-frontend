      ...
      <div class="content">
        <div class="media">
          ...
          <div class="media-content">
            <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Phasellus quis erat porta, suscipit lorem ac, viverra neque. Cras porttitor consectetur orci, dictum faucibus velit mollis sit amet. Nunc ut luctus orci. In leo dolor, varius vel lacinia tincidunt, vestibulum ut purus. Nullam eget tempus arcu. Pellentesque habitant morbi tristique senectus et netus et malesuada fames ac turpis egestas. Vivamus scelerisque mi vitae risus commodo, in convallis enim aliquam. Curabitur hendrerit erat eget magna malesuada, eu imperdiet ante semper. Cras nec fringilla est. Cras faucibus tincidunt porttitor. Nulla id libero quis urna suscipit rutrum quis a nulla. Vivamus vulputate vitae erat quis tristique. olestie.</p>
          </div>
        </div>
      </div>
    </div>
